...
bin = libcppGoslin.so
abin = libcppGoslin.a
domain = cppgoslin/domain/Adduct.o cppgoslin/domain/LipidMolecularSpecies.o cppgoslin/domain/LipidSnPosition.o cppgoslin/domain/LipidStructureDefined.o cppgoslin/domain/FattyAcid.o cppgoslin/domain/LipidAdduct.o cppgoslin/domain/LipidSpecies.o cppgoslin/domain/LipidFullStructure.o cppgoslin/domain/LipidCompleteStructure.o cppgoslin/domain/LipidSpeciesInfo.o cppgoslin/domain/StringFunctions.o cppgoslin/domain/LipidClasses.o cppgoslin/domain/DoubleBonds.o cppgoslin/domain/FunctionalGroup.o cppgoslin/domain/Headgroup.o cppgoslin/domain/Cycle.o cppgoslin/domain/GenericDatastructures.o
