...
class MolecularFattyAcidTest(unittest.TestCase):
    ...
    def test_instanceZero(self):
        instanceZero = MolecularFattyAcid("FA1", 2, 0, 0, UNDEFINED_FA, False, 0)
        assert 0 == instanceZero.num_double_bonds
        
        
    def test_instanceOne(self):
        instanceOne = MolecularFattyAcid("FA1", 2, 1, 0, UNDEFINED_FA, False, 0)
        assert 1 == instanceOne.num_double_bonds
            

    @unittest.expectedFailure
    def test_wrong_bond_type(self):
        instanceZero = MolecularFattyAcid("FA1", 2, -1, 0, UNDEFINED_FA, False, 0)
            
            
    def test_name(self):
        instance = MolecularFattyAcid("FAX", 2, 0, 0, UNDEFINED_FA, False, 0)
