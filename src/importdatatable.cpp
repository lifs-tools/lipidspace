...
ImportDataTable::ImportDataTable(QWidget *parent) : QDialog(parent), ui(new Ui::ImportDataTable) {
    ...
    if (file_name.length() == 0){
        // One does not simply walk into mordor or close a qdialog within the constructor.
        // That's why you have to invoke the close function for an async execution -_-
