...
void Tutorial::first_tutorial_steps(){
    ...
    switch(f_step){
        ...
        case FLipidAssignment:
            ...
            informationLabel->setText("Awesome, now only columns remained in the input field containg lipid names. Please drag them all into the 'Lipid columns' field. You can select all entries by using the [CTRL] + A key combination.");
            lipidSpaceGUI->import_table.ui->ignoreListWidgetCol->setEnabled(true);
