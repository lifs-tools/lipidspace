...
int main(int argc, char** argv) {
    ...
    */
    ...
    /*
        ...
        vector<double> aa = {-3.95553684788094, -0.783048502396993, 1.25806573596846, 1.33132289443035, 2.92599390435717, 3.65280520830133, 3.80451984422776, 5.59045363885885};
        vector<double> bb = {-1.81808225200862, -1.77136750474952, -1.60307376751205, -1.14714805602053, -0.014146294408802, 1.57188077895762, 3.19054176403148, 8.09690519277011};
        vector<double> cc = {-7.3104259245124, -4.75992181203932, -4.15666967177197, -3.17964379149547, -3.04002604627356, -1.78083592676052, -1.65208186241183, -0.546646746913463};
        Array a;
        Array b;
        Array c;
        for (auto v : aa) a.push_back(v);
        for (auto v : bb) b.push_back(v);
        for (auto v : cc) c.push_back(v);
        vector<Array> vec = {a, b, c};
