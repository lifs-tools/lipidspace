...
int main(int argc, char** argv) {
    ...
    */
    ...
    if (argc == 1){
        ...
        vector<double> aa = {47.8616309635065, 48.4824548128906, 56.2948489531462, 60.7245997413855, 68.6559497200464, 73.5023647716054, 77.6630717921042, 80.6245390969841, 82.6563497420657, 84.0662077075618, 84.3472557361942, 85.2081112514554, 87.507734353636, 104.184837843337, 110.038208598462, 112.952554432085, 1, 2, 3};
        vector<double> bb = {16.1622949560285, 19.341092798174, 22.0127041814884, 22.2265958908608, 22.3217022732954, 23.0095879249248, 25.0920096895149, 26.2666087106985, 26.6815024607289, 27.1320980838003, 27.9054194696775, 30.1066720195052, 30.3639387255134, 30.6671690708311, 31.7982492237645, 32.9000002380134, 55, 55};
        Array a;
        Array b;
        for (auto v : aa) a.push_back(v);
        for (auto v : bb) b.push_back(v);
        vector<Array> vec = {a, b};

        double d, s;
        ks_separation_value(a, b, d, s);

        cout << s << endl;


        cout << compute_accuracy(vec) << endl;
